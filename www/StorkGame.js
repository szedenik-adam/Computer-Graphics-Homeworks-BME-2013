...
(function() {
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "StorkGame.data";
  var REMOTE_PACKAGE_BASE = "StorkGame.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_StorkGame.data");
   }
   Module["addRunDependency"]("datafile_StorkGame.data");
 ...
 loadPackage({
  "files": [ {
   "filename": "/7.2.camera.fs",
   "start": 0,
   "end": 1502,
   "audio": 0
  }, {
   "filename": "/7.2.camera.vs",
   "start": 1502,
   "end": 3219,
   "audio": 0
  } ],
  "remote_package_size": 3219,
  "package_uuid": "bab9f9ce-64f7-4d04-b50e-5e1e5ff3c0fe"
 });
})();
...
var wasmBinaryFile = "StorkGame.wasm";
...
var asmLibraryArg = {
 ...
 "fa": _emscripten_set_resize_callback_on_thread,
 "ma": _environ_get,
 ...
 "w": _glGenerateMipmap,
 "v": _glGetError,
 "_": _glGetProgramInfoLog,
 "Z": _glGetProgramiv,
 "Y": _glGetShaderInfoLog,
 "X": _glGetShaderiv,
 ...
 "r": _glViewport,
 "T": _glfwCreateWindow,
 "S": _glfwDefaultWindowHints,
 "R": _glfwGetTime,
 "Q": _glfwInit,
 "P": _glfwMakeContextCurrent,
 "O": _glfwPollEvents,
 "N": _glfwSetFramebufferSizeCallback,
 "M": _glfwSetKeyCallback,
 "L": _glfwSetWindowSize,
 "K": _glfwSwapBuffers,
 "q": _glfwTerminate,
 "g": _glfwWindowHint,
 "I": _strftime_l
...
var ___errno_location = Module["___errno_location"] = function() {
 return (___errno_location = Module["___errno_location"] = Module["asm"]["ua"]).apply(null, arguments);
};
